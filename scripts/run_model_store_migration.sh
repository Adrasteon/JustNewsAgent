#!/usr/bin/env bash
# Run the model store population script in the justnews-v2-py312 conda env
set -euo pipefail
...
conda run --name justnews-v2-py312 python "$PROJECT_ROOT/scripts/populate_model_store.py"
